...
import com.clickawaybuying.shopify.Adapters.ToShipAdapter;
 ...
 * Use the {@link ToShip#newInstance} factory method to
...
public class ToShip extends Fragment {
    ...
    RecyclerView recyclerToShip;
    ImageView imageView;
    TextView textView;

    public static final String PRODUCT_URL = "https://gascojanreb.000webhostapp.com/ShopifyCAB/getToShipOrders.php";
     ...
     * @return A new instance of fragment ToShip.
     */
    // TODO: Rename and change types and number of parameters
    public static ToShip newInstance(String param1, String param2) {
        ToShip fragment = new ToShip();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerToShip = view.findViewById(R.id.recyclerToShip);
        imageView = view.findViewById(R.id.noOrderImg1);
        textView = view.findViewById(R.id.noOrderTxt1);

        loadProducts();
        manager = new GridLayoutManager(getActivity(), 1);
        recyclerToShip.setLayoutManager(manager);
    ...
    public void loadProducts(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PRODUCT_URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        mAdapter = new ToShipAdapter(getActivity(),products);
                        recyclerToShip.setAdapter(mAdapter);
                    }
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String,String> parameters = new HashMap<String, String>();//putting parameters to pass on the php file//putting parameters to pass on the php file
