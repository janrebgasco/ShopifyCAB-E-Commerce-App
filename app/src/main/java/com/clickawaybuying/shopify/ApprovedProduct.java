 ...
 * Use the {@link ApprovedProduct#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ApprovedProduct extends Fragment {
    List<Product> products;
    private RecyclerView.Adapter mAdapter;
    RecyclerView.LayoutManager manager;
    RecyclerView recyclerView;

    public final String PRODUCT_URL = "https://gascojanreb.000webhostapp.com/ShopifyCAB/getApprovedProducts.php";
     ...
     * @return A new instance of fragment ApprovedProduct.
     */
    // TODO: Rename and change types and number of parameters
    public static ApprovedProduct newInstance(String param1, String param2) {
        ApprovedProduct fragment = new ApprovedProduct();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approved_product, container, false);
        recyclerView = view.findViewById(R.id.recyclerApprovedProd);
    ...
    public void loadProducts(){
        StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, PRODUCT_URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        mAdapter = new RecyclerAdapter(getActivity(),products);
