...
import com.clickawaybuying.shopify.Adapters.RefundAdapter;
 ...
 * Use the {@link ReturnRefund#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReturnRefund extends Fragment {
    ...
    public static final String PRODUCT_URL = "https://gascojanreb.000webhostapp.com/ShopifyCAB/getRefundedOrders.php";
     ...
     * @return A new instance of fragment ReturnRefund.
     */
    // TODO: Rename and change types and number of parameters
    public static ReturnRefund newInstance(String param1, String param2) {
        ReturnRefund fragment = new ReturnRefund();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerRefund = view.findViewById(R.id.recyclerRefund);
        imageView = view.findViewById(R.id.noOrderImg6);
        textView = view.findViewById(R.id.noOrderTxt6);

        loadProducts();
        manager = new GridLayoutManager(getActivity(), 1);
        recyclerRefund.setLayoutManager(manager);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PRODUCT_URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        mAdapter = new RefundAdapter(getActivity(),products);
                        recyclerRefund.setAdapter(mAdapter);
                    }
