...
import com.clickawaybuying.shopify.Adapters.CancelledAdapter;
...
public class Cancelled extends Fragment {
    ...
    RecyclerView recyclerCancelled;

    public static final String PRODUCT_URL = "https://gascojanreb.000webhostapp.com/ShopifyCAB/getCancelledOrders.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerCancelled = view.findViewById(R.id.recyclerCancelled);


        loadProducts();
        manager = new GridLayoutManager(getActivity(), 1);
        recyclerCancelled.setLayoutManager(manager);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PRODUCT_URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        mAdapter = new CancelledAdapter(getActivity(),products);
                        recyclerCancelled.setAdapter(mAdapter);
                    }
