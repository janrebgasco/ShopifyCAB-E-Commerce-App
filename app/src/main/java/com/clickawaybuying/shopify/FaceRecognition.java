                ...
                .addOnSuccessListener(
                        new OnSuccessListener<List<FirebaseVisionFace>>() {
                            ...
                            public void onSuccess(List<FirebaseVisionFace> faces) {
                                ...
                                if (faces.size() == 0) {
                                    Toast.makeText(FaceRecognition.this, "Face not Found", Toast.LENGTH_SHORT).show();
                                    fragmentreplace("Key", "Face not found");
                                }

                                for (FirebaseVisionFace face : faces) {
                                    Toast.makeText(FaceRecognition.this, "reached", Toast.LENGTH_SHORT).show();
                                    ...
                                    if (right > 0 & step2verification) {
                                        Toast.makeText(FaceRecognition.this, "turned right", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
