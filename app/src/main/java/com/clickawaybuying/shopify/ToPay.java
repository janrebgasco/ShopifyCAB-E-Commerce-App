...
import com.clickawaybuying.shopify.Adapters.ToPayAdapter;
 ...
 * Use the {@link ToPay#newInstance} factory method to
...
public class ToPay extends Fragment {
    ...
    RecyclerView recyclerToPay;
    ImageView imageView;
    TextView textView;

    final String OFFLINE_URL = "http://192.168.1.5/getOrders.php";
    final String ONLINE_URL = "https://gascojanreb.000webhostapp.com/ShopifyCAB/getOrders.php";
     ...
     * @return A new instance of fragment ToPay.
     */
    // TODO: Rename and change types and number of parameters
    public static ToPay newInstance(String param1, String param2) {
        ToPay fragment = new ToPay();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerToPay = view.findViewById(R.id.recyclerPay);
        imageView = view.findViewById(R.id.noOrderImg);
        textView = view.findViewById(R.id.noOrderTxt);


        loadProducts();
        manager = new GridLayoutManager(getActivity(), 1);
        recyclerToPay.setLayoutManager(manager);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ONLINE_URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        mAdapter = new ToPayAdapter(getActivity(),products);
                        recyclerToPay.setAdapter(mAdapter);
                    }
