...
public class BuyTipAdapter extends RecyclerView.Adapter<BuyTipAdapter.ViewHolder> {
    ...
    public BuyTipAdapter(Context ctx, List<String> titles, List<Integer> images, List<String> description){
        this.mContext = ctx;
        this.titles=titles;
        this.images=images;
