...
public class ToRecieveAdapter extends RecyclerView.Adapter<ToRecieveAdapter.ViewHolder>{

    private Context mContext;
    private List<Product> products = new ArrayList<>();


    public ToRecieveAdapter(Context context, List<Product> products){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder (View view){
            ...
            mColor = view.findViewById(R.id.toReceiveColor);
            mSize = view.findViewById(R.id.toReceiveSize);
            mAddress = view.findViewById(R.id.toReceiveAddress);
    ...
    @NonNull
    @Override
    public ToRecieveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.to_receive_list_item,parent,false);
        return new ToRecieveAdapter.ViewHolder(view);

    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final ToRecieveAdapter.ViewHolder holder, final int position) {
