...
public class RefundAdapter extends RecyclerView.Adapter<RefundAdapter.ViewHolder>{
    ...
    public RefundAdapter(Context context, List<Product> products){
    ...
    public RefundAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RefundAdapter.ViewHolder(view);

    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final RefundAdapter.ViewHolder holder, final int position) {
        ...
        {
            holder.mSize.setVisibility(View.INVISIBLE);
        }
